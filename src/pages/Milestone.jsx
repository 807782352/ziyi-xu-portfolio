...
const MILESTONE_DATA = [
  {
    title: "🤖 Bank of Montreal - Practicum",
    time: "Jan, 2026 - Jun, 2025",
    venue: "Toronto, Canada",
    content:
      "During my practicum at BMO, I am building Customer Lifetime Value (CLV) and persona segmentation models to support value-based marketing strategies. \nI developed a 12-month forward revenue forecasting framework for over 4.5 million U.S. customers by constructing a 36-month analytical dataset with engineered behavioral features. \nUsing Lasso, Random Forest, and XGBoost, along with tenure-based segmentation and expanding-window validation, I improved prediction stability across lifecycle stages. \nI also integrated clustering methods to identify high-return customer personas and designed a pre-campaign ROI simulation framework to guide marketing prioritization.",
    imgUrl:
      "https://downtowncourtenay.com/wp-content/uploads/2019/06/DCBIA_Business_BankOfMontreal.jpg",
    id: "007",
  },
  {
    title: "🤖 Nanjing Yuanquan Software Technology Co., Ltd. - Part-time",
    time: "Feb, 2025 - Jun, 2025",
    venue: "Nanjing, China",
    content:
      "During my role as an LLM Engineer at Nanjing Yuanquan Software Technology Co., I collaborated with a three-member team to develop a 24/7 AI-powered customer support chatbot. \nI worked with multiple LLMs, including GPT, DeepSeek, and Claude, designing prompt flows and optimizing configurations within Dify to enhance response relevance. \nI integrated a RAG pipeline with the company’s knowledge base to deliver context-aware answers and implemented sentiment classification to dynamically adjust response tone.\n We evaluated prototypes based on accuracy, latency, and response quality to identify deployment-ready configurations.",
    imgUrl: "public/images/nanjing-yuanquan.jpg",
    id: "006",
  },
  {
    title: "💻 Outlier - Part-time",
    time: "Apr, 2024 - Feb, 2025",
    venue: "Remote",
    content:
